...
def build_graph(checkpointer: Any | None = None):
    ...
    # 3. Conditional edge after classify
    ...
    # 4. Tool -> Evaluate -> Conditional edge after evaluate
    ...
    # 5. Conditional edge after retry
    builder.add_conditional_edges(
        "retry",
        route_after_retry,
        {
    ...
    # 6. Risky action -> Approval -> Conditional edge after approval
